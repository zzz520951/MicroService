 ...
 * 
 * @Component // 不要忘记添加，不要忘记添加 public class DeptClientServiceFallbackFactory
 * implements FallbackFactory<DeptClientService> {
 * 
 * @Override public DeptClientService create(Throwable throwable) { return new
 * DeptClientService() {
 * 
 * 
 * @Override public Dept get(long id) { return new
 * Dept().setDeptno(id).setDname("该ID：" + id +
